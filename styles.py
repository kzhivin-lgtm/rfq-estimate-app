...
/* UPLOAD_HIDE_STREAMLIT_DRAG_SPAN_V1
   Streamlit adds a red drag-over span:
   "Drag and drop a file here".
   Hide only that native span, keep our section::before text.
*/
...
/* UPLOAD_HIDE_STREAMLIT_DRAG_SPAN_V2
   Hide Streamlit's native drag-over text span:
   "Drag and drop a file here".
   This is the red text that appears only when file is dragged over dropzone.
*/

/* Generic: any span inside the Streamlit dropzone */
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"] span,
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"] span * {
    display: none !important;
    visibility: hidden !important;
...
/* Exact drag-over runtime class found in DevTools */
div[data-testid="stFileUploader"] section.st-emotion-cache-1n7lb4w span,
div[data-testid="stFileUploader"] section.st-emotion-cache-1n7lb4w span * {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
...
/* Keep native dragover text hidden */
div[data-testid="stFileUploader"] section.st-emotion-cache-1n7lb4w span,
div[data-testid="stFileUploader"] section.st-emotion-cache-1n7lb4w span * {
    display: none !important;
    visibility: hidden !important;
...
/* Keep Streamlit native dragover text hidden */
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"][role="presentation"] span,
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"][role="presentation"] span * {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
...
/* Keep native Streamlit drag text hidden */
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"] > span:not(:empty),
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"] > span:not(:empty) * {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
...
/* Reset normal state explicitly */
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"]::before {
    content: "📎 DROP OR UPLOAD YOUR FILES" !important;
}

/* Dragover state only */
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"].st-emotion-cache-1n7lb4w {
    background: rgba(128, 73, 198, 0.14) !important;
    border: 1px solid transparent !important;
    box-shadow: inset 0 0 0 1px #8049C6 !important;
    outline: none !important;
}

/* Hide native red dragover span */
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"].st-emotion-cache-1n7lb4w span,
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"].st-emotion-cache-1n7lb4w span * {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
...
/* UPLOAD_NORMAL_TEXT_RESET_V1
   Force normal upload text back.
*/
div[data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"]::before {
    content: "📎 DROP OR UPLOAD YOUR FILES" !important;
    font-family: var(--mono) !important;
...
/* UPLOAD_DRAGOVER_INNER_LAYER_CLEANUP_V1
   Streamlit dragover adds an inner visual layer:
   section.st-emotion-cache-1n7lb4w > div.st-emotion-cache-14t3qek.
   Kill only this inner layer visuals. Do not touch normal/hover/::before.
*/
div[data-testid="stFileUploader"]
section[data-testid="stFileUploaderDropzone"].st-emotion-cache-1n7lb4w > div,
div[data-testid="stFileUploader"]
section[data-testid="stFileUploaderDropzone"].st-emotion-cache-1n7lb4w > div * {
    background: transparent !important;
    border: 0 !important;
...
/* UPLOAD_DRAGOVER_PLUS_ONLY_V1
   Only replace ::before text with a plus during confirmed dragover state.
   Do not touch background, border, normal state or hover.
*/
div[data-testid="stFileUploader"]
section[data-testid="stFileUploaderDropzone"].st-emotion-cache-1n7lb4w::before {
    content: "+" !important;
    font-family: var(--mono) !important;
